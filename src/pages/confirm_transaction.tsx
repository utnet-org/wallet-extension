...
function ConfirmTransaction() {
    ...
    const [sendAddress, setSendAddress] = React.useState("0x010101011010101001010101101010100101010110101010")
    ...
    const [currentAddress, setCurrentAddress] = useState("0x010101011010101001010101101010100101010110101010")
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className="flex_center_center_column">
                                ...
                                <div style={{margin: "6px 0 4px"}}>
                                    <IdenticonAvatar address={currentAddress} size={32}></IdenticonAvatar>
                                </div>
                                <div
                            ...
                            <div className="flex_center_center_column">
                                ...
                                <div style={{margin: "6px 0 4px"}}>
                                    <IdenticonAvatar address={sendAddress} size={32}></IdenticonAvatar>
                                </div>
                                <div
                                    style={{color: "rgba(21, 28, 26, 0.6)", fontSize: "12px"}}>
                        ...
                        <div
                            ...
                            <div style={{fontSize: "14px"}}>0.0001 u</div>
                        </div>
                        <div
                            style={{
                                width: "100%",
                        ...
                        <div
                            ...
                            <div style={{fontWeight: 600, fontSize: "12px"}}>0.12345 u</div>
                        </div>
                    </div>
                </div>
            )}
