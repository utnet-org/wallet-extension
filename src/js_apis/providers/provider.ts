...
export type BlockReference = { blockId: BlockId } | { finality: Finality } | {
...
export interface ProtocolConfig {
    runtime_config: ProtocolRuntimeConfig;
}
...
export abstract class Provider {
    ...
    abstract experimental_protocolConfig(blockReference: BlockReference): Promise<ProtocolConfig>;
