...
import type {FunctionCallPermissionView} from './providers/provider';

export const MULTISIG_STORAGE_KEY = '__multisigRequest';
export const MULTISIG_ALLOWANCE = new BN(parseAmount('1'));
...
export class Account2FA extends AccountMultisig {
    ...
    public helperUrl = 'https://helper.testnet.org';
